<template>
  <div>
    ...
    <a-layout-sider width="200" style="background: #fff" collapsible>
      ...
      {{ collapsed }} -->
      <a-menu mode="inline" theme="dark" :inline-collapsed:boolean="collapsed" v-model:openKeys="openKeys" v-model:selectedKeys="selectedKeys">
        <a-menu-item key="1">
          <PieChartOutlined />
          <!-- <span>
            <i class="iconfont iconicon-system-zhanwu"></i>
          </span> -->
          <span>Option 1</span>
        </a-menu-item>
        <a-menu-item key="2">
